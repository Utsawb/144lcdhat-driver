...
extern "C"
{
    ...
    extern void bcm2835_smi_set_timing(uint32_t smichannel, uint32_t readchannel, uint32_t setupcycles,
                                       uint32_t strobecycles, uint32_t holdcycles, uint32_t pacecycles);
